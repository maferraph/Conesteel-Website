...
<table border="0" cellpadding="0" cellspacing="0" width="570">
  ...
  <tr>
   <td><a href="?pag=conhecendo_portinhola"><img name="aba_conhecendo" src="imagens/abas/aba_conhecendo_sel.gif" width="110" height="35" border="0" id="aba_conhecendo" alt="" /></a></td>
   <td><img name="aba1_r1_c2" src="imagens/abas/aba1_r1_c2.gif" width="6" height="35" border="0" id="aba1_r1_c2" alt="" /></td>
   <td><a href="?pag=dados_portinhola" onMouseOver="ImagemSelecionadaDados('aba_dados2.gif')" onMouseOut="ImagemSelecionadaDados('aba_dados.gif')"><img name="aba_dados" src="imagens/abas/aba_dados.gif" width="135" height="35" border="0" id="dados" alt="" /></a></td>
...
<table border="0" cellpadding="0" cellspacing="0" width="570">
<tr><td align="center"><a class="con5">Conhecendo e interagindo com a válvula retenção portinhola em 3d:</a></td></tr>
</table>
...
<td>
<a class="texto2"><strong>Atenção</strong>: Para interagir com a válvula retenção portinhola em 3d, você deve ter instalado em seu computador, o plugin do <strong>eDrawings</strong>. Se você utiliza o Internet Explorer 5.5 ou superior como navegador, basta clicar no botão iniciar que o plugin será instalado automaticamente. Se você possui o firefox, clique aqui.</a>
</td>
</tr>
...
<br><br>
<a href="javascript: history.go(-1)"><img src="imagens/voltar.gif" width="97" height="30" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="paginas/3d_portinhola.php" target="top"><img src="imagens/iniciar.jpg" width="97" height="30" border="0"></a>
