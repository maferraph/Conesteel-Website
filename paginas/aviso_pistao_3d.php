...
}                                                Conhecendo e interagindo com a válvula globo em 3d:



	Atenção: Para interagir com a válvula globo em 3d, você deve ter instalado em seu computador, o plugin do eDrawings. Se você utiliza o Internet Explorer 5.5 ou superior como navegador, basta clicar no botão iniciar que o plugin será instalado automaticamente. Se você possui o firefox, clique aqui.
* OBS: O plugin do eDrawings é totalmente gratuito e não demora para instalar.
...
<table border="0" cellpadding="0" cellspacing="0" width="570">
  ...
  <tr>
   <td><a href="?pag=conhecendo_pistao"><img name="aba_conhecendo" src="imagens/abas/aba_conhecendo_sel.gif" width="110" height="35" border="0" id="aba_conhecendo" alt="" /></a></td>
...
<table border="0" cellpadding="0" cellspacing="0" width="570">
<tr><td align="center"><a class="con5">Conhecendo e interagindo com a válvula retenção pistão em 3d:</a></td></tr>
</table>

<center>

<br>
<img src="imagens/titulo_3d.gif" width="436" height="52" border="0">
<br>
...
<tr>
<td><img src="imagens/logoe.gif" border="0"></td>
<td>
<a class="texto2"><strong>Atenção</strong>: Para interagir com a válvula retenção pistão em 3d, você deve ter instalado em seu computador, o plugin do <strong>eDrawings</strong>. Se você utiliza o Internet Explorer 5.5 ou superior como navegador, basta clicar no botão iniciar que o plugin será instalado automaticamente. Se você possui o firefox, clique aqui.</a>
</td>
</tr>
<tr><td colspan="2" height="20"></td></tr>
<tr><td colspan="2" align="center"><a class="texto1">* OBS: O plugin do eDrawings é totalmente gratuito e não demora para instalar.</a></td></tr>
</table>

<br><br>
<a href="javascript: history.go(-1)"><img src="imagens/voltar.gif" width="97" height="30" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="paginas/3d_pistao.php" target="top"><img src="imagens/iniciar.jpg" width="97" height="30" border="0"></a>
